# CCats Gallery - ARKIV Image Viewer

A web-based image gallery for AI-generated cat images stored on the [ARKIV](https://arkiv.network) blockchain.
...
- Browse AI-generated cat images from ARKIV blockchain
...
2. Queries entities filtered by `app="CCats"` and `type="image"`
